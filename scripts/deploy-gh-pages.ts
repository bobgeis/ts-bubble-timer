...
const main = async () => {
  ...
  console.log('Building prod files...')
  execSync('pnpm build')

  console.log('Deleting gh-pages branch from remote...')
  execSync('git push -d origin gh-pages')

  console.log('Creating gh-pages branch locally...')
  execSync('git checkout -B gh-pages')

  console.log('Adding dist...')
  execSync('git add -f dist')

  console.log('Committing dist...')
  ...
  console.log('Deleting gh-pages branch locally...')
